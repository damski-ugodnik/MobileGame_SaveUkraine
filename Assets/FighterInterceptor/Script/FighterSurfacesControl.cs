...
public class FighterSurfacesControl : MonoBehaviour
{
	...
	void Update () {
        ...
        rightElevator.transform.localRotation = Quaternion.Euler(new Vector3(MRx * maxAngle, rightElevatorSetAngle, 0));
        leftElevator.transform.localRotation = Quaternion.Euler(new Vector3(MRx * maxAngle,
